...
export const GAMEDIG_GAME_NAMES: Readonly<Record<string, string>> = {
  ...
  bd: "Base Defense (2017)",
  blackmesa: "Black Mesa (2020)",
  brainbread: "BrainBread",
  brainbread2: "BrainBread 2 (2022)",
  breach: "Breach (2011)",
  breed: "Breed (2004)",
  brink: "Brink (2011)",
  bs: "Blade Symphony (2014)",
  ...
  chaser: "Chaser (2003)",
  chivalry: "Chivalry: Medieval Warfare (2012)",
  chrome: "Chrome (2003)",
  codenamecure: "Codename CURE (2017)",
  codenameeagle: "Codename Eagle (2000)",
  colonysurvival: "Colony Survival (2017)",
  ...
  dayofdragons: "Day of Dragons (2019)",
  ...
  groundbreach: "Ground Breach (2018)",
  ...
  hlopfor: "Half-Life: Opposing Force (1999)",
  halo: "Halo (2003)",
  halo2: "Halo 2 (2007)",
  hll: "Hell Let Loose",
  ...
  insurgencymic: "Insurgency: Modern Infantry Combat (2007)",
  ...
  mumble: "Mumble - GTmurmur Plugin (2005)",
  mumbleping: "Mumble - Lightweight (2005)",
  ...
  onset: "Onset (2019)",
  ohd: "Operation: Harsh Doorstop (2023)",
  ...
  pc: "Project Cars (2015)",
  pc2: "Project Cars 2 (2017)",
  pixark: "PixARK (2018)",
  pvkii: "Pirates, Vikings, and Knights II (2007)",
  ps: "Post Scriptum",
  postal2: "Postal 2",
  prey: "Prey",
  ...
  risingworld: "Rising World (2014)",
  ror2: "Risk of Rain 2 (2020)",
  rune: "Rune",
  rust: "Rust",
  ...
  terminus: "Terminus",
  terraria: "Terraria - TShock (2011)",
  forrest: "The Forrest (2014)",
  thefront: "The Front (2023)",
